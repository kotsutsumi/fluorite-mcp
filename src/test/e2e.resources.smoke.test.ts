...
describe('Spec resources smoke (upsert + read)', () => {
  const ids = [
    ...
    'expo-react-native-ecosystem', 'mobile-native-ecosystem', 'frontend-visualization-ecosystem', 'ui-component-quality', 'vitepress-ecosystem', 'lua-ecosystem', 'ruby-rails-ecosystem', 'modern-tech-ecosystem'
  ]
