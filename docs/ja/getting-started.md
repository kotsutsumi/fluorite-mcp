...
Fluorite MCP へようこそ！このガイドでは、Fluorite MCP と Claude Code CLI の組み合わせを迅速にセットアップして使い始めるお手伝いをいたします。Fluorite MCP の詳しい概要については、[紹介ページ](./introduction.md)をご覧ください。
...
| 次のステップ | 時間 | 目的 |
|-----------|------|---------|
| **[インストールガイド](./installation.md)** | 15分 | 詳細なセットアップとトラブルシューティング |
| **[コマンドリファレンス](./commands.md)** | 30分 | 利用可能なすべての機能を習得 |
...
- **[📋 ドキュメントインデックス](./index.md)** - 完全なドキュメント概要
- **[🔍 検索とナビゲーション](./index.md#クイックナビゲーション)** - 必要な情報を素早く見つける
...
2. **高度な機能を探索** (今週)
   - [インストールガイド](./installation.md) で詳細設定を学ぶ
   - [コマンドリファレンス](./commands.md) で全機能を確認
   - 静的解析機能を試す
