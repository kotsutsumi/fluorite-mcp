...
hero:
  ...
  tagline: "2500以上のスパイクテンプレート、86以上のライブラリ仕様、Claude Code CLIのための高性能開発コンテキスト"
  actions:
    - theme: brand
      text: はじめる
...
| 機能 | ガイド | 説明 |
|---------|-------|-------------|
| **スパイクテンプレート** | **[スパイクテンプレートガイド](./spike-templates.md)** | 2500以上の本番対応開発スキャフォールド |
