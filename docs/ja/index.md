...
hero:
  ...
  tagline: "6,200以上のスパイクテンプレート、86のライブラリ仕様、Claude Code CLIのための高性能開発コンテキスト"
  actions:
    - theme: brand
      text: はじめる
...
features:
  ...
  - icon: 🌐
    title: 多言語エコシステム
    details: TypeScript、Python、Go、Rust、Java、C#、PHPなど、モダンな開発エコシステムをサポート。
  - icon: 🔍
    title: インテリジェント静的解析
    details: フレームワーク固有解析のための50以上の検証ルール。エラー予測とパフォーマンス最適化を内蔵。
  - icon: ⚡
    title: 即座のコード生成
    details: 正しいインポートとベストプラクティスを備えた本番対応コード。設定不要。
  - icon: 🎯
    title: 組み込みベストプラクティス
    details: すべての実装にセキュリティ、パフォーマンス、デザインパターンが組み込まれています。
---
...
- **📖 94以上のライブラリ仕様**: 詳細な使用パターン、設定例、アーキテクチャガイダンス
